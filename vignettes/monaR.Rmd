...
In instances where the target molecule has several stereo isomers, all isomer matches can be retrieved by queyring by the connectivity part of the InChI Key alone, which is encoded in the first 14 character. 
...
### Identifier queries 
```{r, include=F, eval=T}
id_query_rst <- example_id_query
spec_query_rst <- example_spec_query
```
